...
*/
ob_start();
$API_KEY = "1516484637:AAGoy7sQlHhr9_09jAnfoJjP7BHFZflvQdk";//توكنك
$buy = "@PROTECTmnbot";// معرفك
$sudo = "909279851";//ايديك
$admin = "$sudo";// ماتغير شي
$idBot = "1516484637";// ايدي بوتك
$admmm = $sudo;//ماتغير شي
$Dev = array("$sudo", "" );
$userrr = "Hemaya5_bot";// معرف بوتك بدون @
